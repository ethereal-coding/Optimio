    ...
    <header className="fixed top-0 left-16 right-0 h-14 flex items-center justify-between gap-4 border-b border-border bg-background px-4 z-40">
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          <div className="flex items-center gap-0.5">
            <Tooltip>
              ...
              <TooltipContent side="bottom" sideOffset={8} className="bg-popover border-border text-foreground">Previous day</TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
              ...
              <TooltipContent side="bottom" sideOffset={8} className="bg-popover border-border text-foreground">Next day</TooltipContent>
            </Tooltip>
          </div>
      ...
      <div className="flex items-center gap-3 ml-auto">
        ...
        <Tooltip>
          ...
          <TooltipContent side="bottom" sideOffset={8} className="bg-popover border-border text-foreground">Notifications</TooltipContent>
        </Tooltip>
